...
4. Output Format: Return the flashcards in a JSON array, where each flashcard is an object with the keys 'front' (the question) and 'back' (the explanation, along with any validated code examples in python or golang).
`
